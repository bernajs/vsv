<div class="row my-md-5">
  ...
  <div class="col-12 col-md-8 div-listado-quintas px-md-4">
    <div class="row">
  ...
  <div class="col-12 quintas">
    ...
    <div class="col-12 col-md-7 py-4 quinta-descripcion">
      ...
      <div class="col-12">
          ...
          <h4>$650</h4>
          <p class="my-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
          <div class="row">
            <div class="col-4">
            <i class="fa fa-star-o" aria-hidden="true"></i>
            <i class="fa fa-star-o" aria-hidden="true"></i>
...
<style media="screen">
  ...
  .quinta-descripcion{background-color: #f7f7f7;}
</style>
